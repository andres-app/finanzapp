...
?><!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Mi Dinero</title><link rel="stylesheet" href="<?=e(app_url('assets/css/app.css'))?>"></head><body class="login-bg">
<div class="login-shell"><div class="login-brand"><span class="logo-symbol"><i></i><i></i><i></i><i></i></span><b>mi dinero</b></div><div class="login-card"><span class="eyebrow">FINANZAS FAMILIARES</span><h1>Bienvenido</h1><p>Ingresa para revisar tus ingresos, gastos y metas en tiempo real.</p><?php if($error):?><div class="alert error"><?=e($error)?></div><?php endif;?><form method="post"><label>Correo</label><input type="email" name="email" autocomplete="email" required><label>Contraseña</label><input type="password" name="password" autocomplete="current-password" required><button class="btn primary block">Ingresar</button></form></div><small class="login-foot">Control privado de tus finanzas.</small></div></body></html>
